...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/HYscience/HYscience.git")).toEqual({
    owner: "HYscience",
    repo: "HYscience",
  })
})
...
test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/HYscience/HYscience")).toEqual({
    owner: "HYscience",
    repo: "HYscience",
  })
})
...
test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:HYscience/HYscience.git")).toEqual({
    owner: "HYscience",
    repo: "HYscience",
  })
})
...
test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:HYscience/HYscience")).toEqual({
    owner: "HYscience",
    repo: "HYscience",
  })
})
...
test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/HYscience/HYscience.git")).toEqual({
    owner: "HYscience",
    repo: "HYscience",
  })
})
...
test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/HYscience/HYscience")).toEqual({
    owner: "HYscience",
    repo: "HYscience",
  })
})
