...
> **CRITICAL:** All plotting runs headless in hyscience (MPLBACKEND=Agg). **Never call `plt.show()`** — always save to file: `fig.savefig("plot.png", dpi=150, bbox_inches="tight")`.
