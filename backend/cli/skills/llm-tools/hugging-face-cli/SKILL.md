...
HuggingFace token is auto-injected by hyscience when connected via the dashboard.
...
If not set: connect HuggingFace at https://app.hyscience.ai -> Services, then restart hyscience.
