...
author: HYscience
license: MIT
tags: [Agents, CrewAI, Multi-Agent, HYsciencetion, Collaboration, Role-Based, Autonomous, Workflows, Memory, Production]
dependencies: [crewai>=1.2.0, crewai-tools>=1.2.0]
---

# CrewAI - Multi-Agent HYsciencetion Framework
