...
export namespace LLM {
  ...
  export async function stream(input: StreamInput) {
    ...
    return streamText({
      ...
      headers: {
        ...(input.model.providerID.startsWith("hysci")
          ? {
              "x-hyscience-project": Instance.project.id,
              "x-hyscience-session": input.sessionID,
              "x-hyscience-request": input.user.id,
              "x-hyscience-client": Flag.HYSCIENCE_CLIENT,
            }
