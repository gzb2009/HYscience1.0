...
export type BiologyProfile = "genomics" | "single-cell" | "proteomics" | "structure" | "chemo"
...
export namespace BiologyProfile {
  ...
  export function fromMarker(text: string): BiologyProfile | undefined {
    const m = text.match(/<biology-profile>\s*(genomics|single-cell|proteomics|structure|chemo)\s*<\/biology-profile>/i)
