...
export const GlobalRoutes = lazy(() =>
  new Hono()
    .get(
      ...
      describeRoute({
        summary: "Get health",
        description: "Get health information about the HYscience server.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Subscribe to global events from the HYscience system using server-sent events.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the current global HYscience configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update global HYscience configuration settings and preferences.",
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose all HYscience instances, releasing all resources.",
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Refresh HYscience account services and reload local provider/config state.",
      ...
      async (c) => {
        const result = await HYscience.syncServices()
        Provider.invalidate()
        await Instance.disposeAll()
        GlobalBus.emit("event", {
          directory: "global",
