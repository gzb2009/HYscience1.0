import type { Hooks, PluginInput, Plugin as PluginInstance } from "@hysci/plugin"
import { Config } from "../config/config"
import { Bus } from "../bus"
import { Log } from "../util/log"
import { createHYscienceClient } from "@hysci/sdk"
...
export namespace Plugin {
  ...
  const state = Instance.state(async () => {
    const client = createHYscienceClient({
      baseUrl: "http://hyscience.internal",
    ...
    if (!Flag.HYSCIENCE_DISABLE_DEFAULT_PLUGINS) {
