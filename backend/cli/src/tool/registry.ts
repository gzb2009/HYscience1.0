...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@hysci/plugin"
import z from "zod"
...
import { BiologyTools, BIOLOGY_QUERY_TOOL_IDS, BIOLOGY_RUNTIME_TOOL_IDS } from "./biology"
...
export namespace ToolRegistry {
  ...
  async function all(): Promise<Tool.Info[]> {
    ...
    return [
      InvalidTool,
      ...(["app", "cli", "desktop"].includes(Flag.HYSCIENCE_CLIENT) ? [QuestionTool] : []),
      BashTool,
      ReadTool,
      GlobTool,
      GrepTool,
      ...
      SkillTool,
      ApplyPatchTool,
      ...(Flag.HYSCIENCE_EXPERIMENTAL_LSP_TOOL ? [LspTool] : []),
      ...(config.experimental?.batch_tool === true ? [BatchTool] : []),
      ...(Flag.HYSCIENCE_EXPERIMENTAL_PLAN_MODE && Flag.HYSCIENCE_CLIENT === "cli"
