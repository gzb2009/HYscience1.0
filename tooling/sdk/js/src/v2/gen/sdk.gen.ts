...
import type {
  ...
  SettingsComputeExecutionSetErrors,
  SettingsComputeExecutionSetResponses,
...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new HyscienceClient()" to fix this error.`)
    }
    return instance
  }
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global HYscience configuration settings and preferences.
   */
   ...
   *
   * Update global HYscience configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the HYscience server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the HYscience system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all HYscience instances, releasing all resources.
   */
   ...
   *
   * Refresh HYscience account services and reload local provider/config state.
   */
...
export class Account extends HeyApiClient {
   ...
   * Get account
   *
   * Get synced HYscience account and billing summary.
   */
  public get<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
...
export class Storage extends HeyApiClient {
   ...
   * Get storage usage
   *
   * Real on-disk sizes for the HYscience data directory and its top-level entries.
   */
...
export class Execution extends HeyApiClient {
  /**
   * Set compute execution tier
   *
   * Choose where agent runs execute: local kernels, SSH/Slurm hosts, or cloud GPUs.
   */
  public set<ThrowOnError extends boolean = false>(
    parameters?: {
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "body", key: "execution" }] }])
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with HYscience.
   */
   ...
   * Get current project
   *
   * Retrieve the currently active project that HYscience is working with.
   */
      ...
      [
        {
          args: [
            ...
            { in: "body", key: "resultFolder" },
            { in: "body", key: "research" },
            { in: "body", key: "icon" },
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by HYscience.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current HYscience configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update HYscience configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Provenance extends HeyApiClient {
   ...
   *
   * List all nodes in the local provenance DAG, optionally filtered by path.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Return a provenance node and its connected lineage.
   */
  public query<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<ProvenanceQueryResponses, unknown, ThrowOnError>({
      url: "/provenance/{id}",
      ...options,
      ...params,
    })
...
export class Session extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all HYscience sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new HYscience session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific HYscience session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class File extends HeyApiClient {
   ...
   * Ensure directory
   *
   * Create a directory inside the current project if it does not exist.
   */
  public ensureDirectory<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<FileEnsureDirectoryResponses, unknown, ThrowOnError>({
   ...
   * Migrate directory
   *
   * Move the contents of one project directory into another and remove the old directory.
   */
  public migrateDirectory<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      from?: string
      to?: string
    ...
    return (options?.client ?? this.client).post<FileMigrateDirectoryResponses, unknown, ThrowOnError>({
   ...
   * Delete file
   *
   * Delete a file inside the current project directory.
   */
  public delete<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Open local file
   *
   * Reveal a project file in the OS file manager, or open it with the default / preferred app.
   */
  public open<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<FileOpenResponses, unknown, ThrowOnError>({
      url: "/file/open",
      ...options,
      ...params,
      headers: {
   ...
   * Rename file
   *
   * Rename a file inside the current project directory.
   */
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current HYscience instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the HYscience system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the HYscience system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the HYscience system.
   */
...
export class HyscienceClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<HyscienceClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    HyscienceClient.__registry.set(this, args?.key)
  }
