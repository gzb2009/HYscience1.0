...
const GITHUB = "https://github.com/HYscience/hyscience"
const DOCS = "https://hyscience.sh/docs"
const NPM_CMD = "npm i -g @hysci/hyscience"
const CURL_CMD = "curl -fsSL https://hyscience.sh/install | bash"
...
/* OsMark — HYscience agent icon (static). */
function OsMark({ size = 15 }: { size?: number }) {
  return (
    ...
    >
      <circle cx="12" cy="12" r="10" fill="var(--background-base, #f2f2f0)" stroke="currentColor" strokeWidth="0.8" />
      <path d="M12 2A10 10 0 0 0 12 22C15 22 15 18.6 12 17C10 16.1 10 7.9 12 7C15 5.4 15 2 12 2Z" fill="currentColor" />
      <circle cx="12" cy="12" r="7" fill="var(--background-base, #f2f2f0)" stroke="currentColor" strokeWidth="0.8" />
      <path
    ...
    <section className="relative h-screen min-h-[680px] w-full bg-background overflow-hidden grain">
      ...
      <div className="absolute inset-0 z-10 mx-auto flex h-full max-w-[1400px] flex-col px-6 sm:px-10">
        <div className="hero-text rise self-start mt-[9vh]" style={{ animationDelay: "120ms" }}>
          <div className="text-[clamp(40px,6.4vw,96px)] leading-[0.9] tracking-[-0.04em]">hyscience</div>
          <a
            href="https://hyscience.ai"
            target="_blank"
            rel="noreferrer"
        ...
        <div ref={copy} className="hero-text mt-auto mb-[5vh] self-end text-right max-w-[820px]">
          ...
          >
            <Cta href="#install">Install HYscience</Cta>
          ...
          <div className="max-w-[900px] mx-auto text-center">
            ...
            <Reveal delay={320}>
              <div className="mt-10 flex flex-col items-center gap-4">
                ...
                <span className="font-terminal text-[12.5px] text-foreground/60">github.com/HYscience/hyscience</span>
              </div>
            </Reveal>
          </div>
        </div>
      ...
      <footer className="relative overflow-hidden">
        <div className={`mx-auto max-w-[1400px] px-6 sm:px-10 pt-16 pb-10 border-t border-border/40 ${LABEL}`}>
          <div className="grid grid-cols-12 gap-10">
            <div className="col-span-12 md:col-span-5">
              <div className="flex items-center gap-2.5 text-foreground">
                <OsMark size={15} />
                <span className="font-display text-[22px] tracking-tight leading-none">hyscience</span>
              </div>
              <p className="mt-4 max-w-[36ch] text-[13.5px] leading-[1.7] text-foreground/55">
                The open-source AI workbench for scientific research, by HYscience.
              </p>
            </div>
            <div className="col-span-6 sm:col-span-4 md:col-span-2">
              ...
              <ul className="space-y-2.5 text-[13.5px]">
                ...
                <li>
                  <a
                    href="https://www.npmjs.com/package/@hysci/hyscience"
                    target="_blank"
                    rel="noreferrer"
                    className="link-underline text-foreground/70 hover:text-foreground"
                  >
          ...
          <div className="mt-14 pt-6 border-t border-border/40 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-[12.5px] text-foreground/45">
            <div>&copy; {new Date().getFullYear()} HYscience. Apache 2.0.</div>
        ...
        <div className="relative h-[13vw] min-h-[90px] max-h-[200px] overflow-hidden" aria-hidden>
          <div className="footer-watermark absolute left-1/2 -translate-x-1/2 top-[0.04em] text-center">hyscience</div>
        </div>
      </footer>
    </div>
  )
