import type { AgentPart as MessageAgentPart, FilePart, Part, TextPart } from "@hysci/sdk/v2"
...
function textPartValue(parts: Part[]) {
  const candidates = parts
    ...
    .filter((part) => !part.hybio && !(part as { synthetic?: boolean }).synthetic && !part.ignored)
