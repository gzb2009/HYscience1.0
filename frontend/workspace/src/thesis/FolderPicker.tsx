 ...
 *
 * Backed by hyscience's /file endpoint, which walks the real filesystem
...
export function FolderPicker(props: PickerProps): JSX.Element {
  ...
  const confirmTitle = () =>
    purpose() === "workspace" ? "Use this folder as the workspace" : "open the current folder as a project"
