...
export const IconCircle = (p: IconProps): JSX.Element => (
  <svg xmlns="http://www.w3.org/2000/svg" {...baseProps(p)}>
...
export const IconMoreV = (p: IconProps): JSX.Element => (
  <svg xmlns="http://www.w3.org/2000/svg" {...baseProps(p)}>
    <circle cx="12" cy="12" r="1" />
...
export const IconEyeOff = (p: IconProps): JSX.Element => (
  <svg xmlns="http://www.w3.org/2000/svg" {...baseProps(p)}>
    ...
    <path d="M6.6 6.6C3.9 8.4 2 12 2 12s3.5 7 10 7a10.4 10.4 0 0 0 5.4-1.5" />
    <path d="m2 2 20 20" />
...
export const IconLink = (p: IconProps): JSX.Element => (
  <svg xmlns="http://www.w3.org/2000/svg" {...baseProps(p)}>
    <path d="M10 13a5 5 0 0 0 7.5.5l1.5-1.5a5 5 0 0 0-7.1-7.1L10.5 6.4" />
    <path d="M14 11a5 5 0 0 0-7.5-.5L5 12a5 5 0 0 0 7.1 7.1l1.4-1.4" />
  </svg>
)
...
export const IconCloudUp = (p: IconProps): JSX.Element => (
  <svg xmlns="http://www.w3.org/2000/svg" {...baseProps(p)}>
    <path d="M12 12v9" />
    <path d="m16 16-4-4-4 4" />
    <path d="M20.4 16.4A5 5 0 0 0 18 7h-1.3A7 7 0 1 0 4 15.3" />
  </svg>
)
