 ...
 *
 * Both are keyed by the hyscience project worktree (absolute path) and
 * persisted to localStorage so they survive reloads. We do NOT delete
 * the project from hyscience itself — hyscience tracks workspaces globally,
...
moduleEffect(() => writeSet(FAV_KEY, favorites()))
moduleEffect(() => writeSet(HIDE_KEY, hidden()))
