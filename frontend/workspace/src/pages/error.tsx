  ...
  return (
    ...
    >
      <div class="w-2/3 max-w-3xl flex flex-col items-center justify-center gap-8">
        <div class="text-24-medium text-text-strong tracking-tight opacity-50 shrink-0">HYscience</div>
        ...
        <div class="flex flex-col items-center gap-2">
          <div class="flex items-center justify-center gap-1">
            ...
            <button
              ...
              onClick={() => platform.openLink("https://github.com/HYscience/HYscience/issues")}
            >
