export const dict = {
  ...
  "dialog.project.new.updatedExisting": "This folder is already a project — details were updated (one project per folder)",
  ...
  "home.capabilities.skills.githubHint": "Skills are fetched, screened by a multi-layer security review, and only installed if they pass.",
  ...
  "home.capabilities.skills.uploadInvalid": "The SKILL.md must start with a frontmatter block containing name and description.",
