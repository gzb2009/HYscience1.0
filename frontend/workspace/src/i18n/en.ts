export const dict = {
  ...
  "home.capabilities.skills.deleteConfirm": "Delete skill \"{{name}}\"?",
  ...
  "home.capabilities.compute.localHint": "Runs execute on this machine. Switch tier by selecting a compute card.",
