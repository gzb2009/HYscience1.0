...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i HYscience.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i HYscience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i HYscience.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i hyscience.json",
  ...
  "dialog.server.description": "Bytt hvilken HYscience-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av HYscience ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til HYscience-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (hyscience.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at HYscience ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "HYscience inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for HYscience",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan HYscience ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan HYscience er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når HYscience starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av HYscience.",
