...
export const dict = {
  ...
  "dialog.project.new.directoryHint":
    "选择数据所在的父目录。每个方向会在其下使用独立工位文件夹，结果写入该工位的 result/。",
  ...
  "dialog.project.new.workspacePreview": "方向工位",
  "dialog.project.new.resultPreview": "结果目录",
  "dialog.project.new.resultHint": "产物固定写在该方向工位下的 result/。",
  "dialog.project.new.isolateFailed": "无法把该方向从父目录里隔离开，请换一个文件夹再试。",
  ...
  "dialog.project.new.updatedExisting": "该方向工位已存在，已更新信息",
  "home.menu.pin": "置顶项目",
  ...
  "chat.welcome.imc.1": "分析 IMC / CODEX 空间蛋白组数据，比较组织区域间的细胞组成与邻域关系。",
