...
export const dict = {
  ...
  "dialog.provider.hysci.note": "使用 HYscience Cloud 或 API 密钥连接",
  ...
  "dialog.project.new.directoryHint": "选择本地文件夹作为项目根目录。",
  ...
  "home.capabilities.label": "Skills 与 Compute",
  "home.capabilities.viewAll": "查看全部",
  "home.capabilities.manage": "在设置中管理",
  ...
  "home.capabilities.skills.deleteConfirm": "删除技能「{{name}}」？",
  ...
  "home.capabilities.skill.on": "开",
  "home.capabilities.skill.off": "关",
  "home.capabilities.compute.title": "Compute",
  "home.capabilities.compute.titleAll": "Compute · 全部环境",
  ...
  "home.capabilities.compute.localHint": "在本机执行。点击卡片切换默认执行环境。",
