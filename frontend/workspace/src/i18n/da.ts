export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i HYscience.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i HYscience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i HYscience.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i hyscience.json",
  ...
  "dialog.server.description": "Skift hvilken HYscience-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af HYscience ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til HYscience-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (hyscience.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, HYscience understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "HYscience inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for HYscience",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan HYscience ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan HYscience er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når HYscience starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af HYscience.",
