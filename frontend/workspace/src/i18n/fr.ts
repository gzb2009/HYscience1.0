export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans HYscience.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans HYscience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans HYscience.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans hyscience.json",
  ...
  "dialog.server.description": "Changez le serveur HYscience auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'HYscience ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe HYscience",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (hyscience.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'HYscience ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "HYscience inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour HYscience",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'HYscience sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'HYscience.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'HYscience",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'HYscience.",
