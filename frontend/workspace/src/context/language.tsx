...
import { dict as uiEn } from "@hysci/ui/i18n/en"
...
const UI_DICTS: Record<NonEn, () => Promise<{ dict: unknown }>> = {
  zh: () => import("@hysci/ui/i18n/zh"),
  zht: () => import("@hysci/ui/i18n/zht"),
  ko: () => import("@hysci/ui/i18n/ko"),
  de: () => import("@hysci/ui/i18n/de"),
  es: () => import("@hysci/ui/i18n/es"),
  fr: () => import("@hysci/ui/i18n/fr"),
  da: () => import("@hysci/ui/i18n/da"),
  ja: () => import("@hysci/ui/i18n/ja"),
  pl: () => import("@hysci/ui/i18n/pl"),
  ru: () => import("@hysci/ui/i18n/ru"),
  ar: () => import("@hysci/ui/i18n/ar"),
  no: () => import("@hysci/ui/i18n/no"),
  br: () => import("@hysci/ui/i18n/br"),
  th: () => import("@hysci/ui/i18n/th"),
}
