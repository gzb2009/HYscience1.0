...
import type { IconProps } from "@hysci/ui/icon"
import { DropdownMenu } from "@hysci/ui/dropdown-menu"

// Shared visual language for the HYscience settings panels. Matches the
// reference (rounded cards, muted subheaders, filter/search/add toolbar) while
// Settings panels inherit Inter via @hysci/ui theme tokens — no local font overrides.
