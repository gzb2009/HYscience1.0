export const dict = {
  ...
  "ui.sessionTurn.resultFile.sheetBlurb":
    "Ark: delmængdeoversigt (farvekodet), behold-til-videre (prioritet), kontaminering og nøgleresultater.",
  "ui.sessionTurn.resultFile.spreadsheet": "Regneark",
  "ui.sessionTurn.resultFile.table": "Tabel",
  ...
  "ui.messagePart.reasoning.title": "Tankeproces",
