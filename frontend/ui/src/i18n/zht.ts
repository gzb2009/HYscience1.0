...
export const dict = {
  ...
  "ui.sessionTurn.resultFile.viewFile": "檢視 {{name}}",
  "ui.sessionTurn.stopped": "已停止",
  "ui.sessionTurn.resultFile.sheetBlurb":
    "工作表：亞群彙總（可信度 ✓/⚠/△/✗）、下游保留列表（優先級）、污染報告與統計、關鍵發現與建議。",
  ...
  "ui.sessionTurn.status.waitingChoice": "等待選擇",
  ...
  "ui.messagePart.reasoning.title": "思考過程",
  ...
  "ui.question.custom.placeholder": "或輸入你的答案…",
  "ui.question.recommended": "推薦",
  "ui.question.action.edit": "改選擇",
  "ui.question.action.agentDecide": "由智慧體決定",
  "ui.question.revise.hint": "改答案 — 提交後將從這個問題起撤回並重跑。",
  "ui.question.action.back": "返回",
  "ui.question.action.stop": "停止",
  "ui.question.action.skip": "跳過，由你決定",
  "ui.question.action.useRecommended": "按推薦繼續",
  "ui.question.skip.default": "由智慧體決定",
  "ui.question.decision.waiting": "已保留推薦方案。可按推薦繼續、另選，或停止；不必必須作答。",
