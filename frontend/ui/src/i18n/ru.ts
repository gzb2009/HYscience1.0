export const dict = {
  ...
  "ui.sessionTurn.resultFile.sheetBlurb":
    "Листы: сводка подгрупп (цвет), список для дальнейшего анализа (приоритет), контаминация и ключевые выводы.",
  "ui.sessionTurn.resultFile.spreadsheet": "Таблица",
  "ui.sessionTurn.resultFile.table": "Таблица",
  "ui.sessionTurn.resultFile.file": "Файл",
  ...
  "ui.messagePart.reasoning.title": "Ход рассуждений",
