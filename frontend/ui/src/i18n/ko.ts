export const dict = {
  ...
  "ui.sessionTurn.resultFile.sheetBlurb": "시트: 아군 요약(색상 코딩), 하류 유지 목록(우선순위), 오염 보고, 핵심 발견.",
  "ui.sessionTurn.resultFile.spreadsheet": "스프레드시트",
  "ui.sessionTurn.resultFile.table": "표",
  "ui.sessionTurn.resultFile.file": "파일",
