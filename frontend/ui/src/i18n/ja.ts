export const dict = {
  ...
  "ui.sessionTurn.resultFile.sheetBlurb":
    "シート：亜群サマリー（色分け）、下流解析用リスト（優先度）、汚染報告、主要所見。",
  "ui.sessionTurn.resultFile.spreadsheet": "スプレッドシート",
  "ui.sessionTurn.resultFile.table": "表",
  "ui.sessionTurn.resultFile.file": "ファイル",
  ...
  "ui.messagePart.reasoning.title": "思考プロセス",
