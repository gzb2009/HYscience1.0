...
export const dict = {
  ...
  "ui.sessionTurn.status.loadingSkill": "加载技能中",
  ...
  "ui.sessionTurn.status.literatureReview": "文献检索中",
  "ui.sessionTurn.status.reasoning": "推理分析中",
  "ui.sessionTurn.status.designingMethodology": "设计方法学",
  "ui.sessionTurn.status.runningComputation": "计算中",
