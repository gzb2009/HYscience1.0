...
import hyscienceThemeJson from "./themes/hyscience.json"
import synsc1ThemeJson from "./themes/hyscience-1.json"
...
import absolutelyThemeJson from "./themes/absolutely.json"

export const hyscienceTheme = hyscienceThemeJson as DesktopTheme
...
export const absolutelyTheme = absolutelyThemeJson as DesktopTheme

export const DEFAULT_THEMES: Record<string, DesktopTheme> = {
  hyscience: hyscienceTheme,
  "hyscience-1": synsc1Theme,
  absolutely: absolutelyTheme,
  aura: auraTheme,
  ayu: ayuTheme,
