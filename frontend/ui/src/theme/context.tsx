...
const STORAGE_KEYS = {
  THEME_ID: "hyscience-theme-id",
  COLOR_SCHEME: "hyscience-color-scheme",
  THEME_CSS_LIGHT: "hyscience-theme-css-light",
  THEME_CSS_DARK: "hyscience-theme-css-dark",
} as const

const THEME_STYLE_ID = "hyscience-theme"
...
function applyThemeCss(theme: DesktopTheme, themeId: string, mode: "light" | "dark") {
  ...
  document.getElementById("hyscience-theme-preload")?.remove()
...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: { defaultTheme?: string }) => {
    const [store, setStore] = createStore({
      ...
      themeId: props.defaultTheme ?? "hyscience",
