...
<img src="assets/wordmark.svg" alt="HYscience" width="440">
...
[![CI](https://github.com/HYscience/HYscience/actions/workflows/ci.yml/badge.svg)](https://github.com/HYscience/HYscience/actions/workflows/ci.yml)
[![npm](https://img.shields.io/npm/v/%40hysci%2Fhyscience?label=%40hysci%2Fhyscience&color=0d9488)](https://www.npmjs.com/package/@hysci/hyscience)
...
Platform binaries are also attached to [GitHub Releases](https://github.com/HYscience/HYscience/releases); see the [changelog](CHANGELOG.md) for what's new in each version.
...
Global config lives in `~/.config/hyscience/hyscience.json`. Project config lives in `hyscience.json` or a `.hyscience/` directory at the repo root ([schema](https://hyscience.sh/config.json)). Custom agents, commands, tools, plugins, and themes load from those directories.
